...
public class MenuAlunosControle {	
    ...
    public void initialize() {
    	...
    	this.alunos = FXCollections.observableArrayList(this.alunoDao.listaTodosAlunos());
    	tabelaAlunos.setItems(alunos);
    	alunoPaginacao.setPageCount(alunos.size()/4+1);
    }
